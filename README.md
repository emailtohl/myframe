...
本项目是我锻炼基本编程水平的代码库，实现的功能早已有相关框架或工具所支持，如MVC，IOC，json解析等，属于“重复造轮子”，在实际项目中更多的还是选用工业标准的第三方软件，编写它们纯粹是个人提升和自娱自乐。

本项目由5个模块组成：

-   frame-util ：为其他模块提供基础工具功能，如**对象分析**，HTTP**客户端**，**Class扫描**等；

-   frame-ioc ：如同spring容器那样，实现反转控制和依赖注入功能，可将Bean单例化，并解耦模块之间的关系；
...
目前，已在frame-ioc项目中模仿Spring容器，实现了反转控制和依赖注入功能，此特性能让业务代码解耦，易测试，易扩展，易维护，而该特性更多好处还在于为管理的Bean提供各类代理功能，如安全认证、表单校验、JTA事务等等，这些代理特性差不多都已纳入到了JavaEE规范中。不过，此种容器级的开发，工程量挺大，我将逐步添加此特性。
